...
// ************************************************************
// Model for cooking tools in the shape of a Harley Quinn Meeple:
// - cookie cutter
...
scale([1,1,1]){
  ...
  // "mold" : the positive shape to create a mold of a Harley Quinn meeple
  ...
  if (export == "cookie_cutter") {
    meeple_harleyquinn_cookie_cutter(cutter_scale, cutter_height, cutter_thickness, cutter_color);
    
  }
  else if (export == "cookie_petg") {
    meeple_harleyquinn_cookie_cutter(cutter_scale, cutter_height, cutter_thickness, cutter_color, "PETG");
    ...
    $fn = 30;
    meeple_harleyquinn_cookie_cutter(cutter_scale, cutter_height, cutter_thickness);
  }
...
module meeple_harleyquinn_shape(){
