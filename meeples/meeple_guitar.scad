...
scale([1,1,1]){
  ...
  if (export == "cookie_cutter") {
    ...
    meeple_guitarist_cookie_cutter(cutter_scale, cutter_height, cutter_thickness, "PETG");
...
module meeple_guitarist_cookie_cutter(cutter_scale, cutter_height, cutter_thickness, filament="PLA"){
  difference() {
